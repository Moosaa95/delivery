      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-cyan-500 to-blue-600 text-white rounded-lg shadow-lg p-6 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1">123 Logistics Way, Shipping District, ST 12345, USA</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1">(218) 618-7994</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1">info@crustockglobaldelivery.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1">Monday - Friday: 8am - 5pm EST</p>
                  </div>
                </div>
              </div>
              ...
              {isSubmitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-3 px-6 rounded-lg font-medium flex items-center justify-center hover:from-cyan-600 hover:to-blue-700 transition-colors"
                    >
