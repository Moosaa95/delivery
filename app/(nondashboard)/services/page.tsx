...
export default function ServicesPage() {
  const mainServices = [
    ...
    },
    {
      ...
      image: "/images/warehousing-service.jpg",
  ...
  const otherServices = [
    ...
    },
    {
      ...
      image: "/images/foreign-to-foreign.jpg",
    ...
    },
    {
      ...
      image: "/images/household-autos.jpg",
    ...
    },
    {
      ...
      image: "/images/roll-on-roll-off.jpg",
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Other Services</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
