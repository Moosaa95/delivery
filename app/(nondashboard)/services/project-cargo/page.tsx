              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mb-8">
                  <p className="text-gray-700 mb-4">
                    Swift Logistics specializes in the transportation of complex, oversized, and high-value project cargo 
                  ...
                  <p className="text-gray-700 mb-4">
                    Swift Logistics offers end-to-end project cargo solutions that encompass every aspect of your oversized 
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-700 mb-4">
                    Swift Logistics maintains an extensive global network of specialized equipment providers, carriers, port 
                  ...
                  <p className="text-gray-700">
                    ...
                    requirements. Swift Logistics provides centralized project management with a dedicated Project Director who 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  <div>
                    ...
                    <p className="text-gray-700 mb-4">
                      Swift Logistics offers specialized transport engineering services including technical feasibility studies, 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 relative">
                      ...
                      <p className="text-gray-700 italic mb-4 relative z-10">
                        "Swift Logistics handled the transportation of four 120-ton turbines for our power plant project in 
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 relative">
                      ...
                      <p className="text-gray-700 italic mb-4 relative z-10">
                        ...
                        challenging terrain and underdeveloped infrastructure. Swift Logistics conducted comprehensive route 
                  ...
                  <div className="space-y-6">
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Swift Logistics' dedicated project engineering team brings specialized technical knowledge to every 
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Swift Logistics maintains strategic partnerships with specialized equipment providers worldwide, 
